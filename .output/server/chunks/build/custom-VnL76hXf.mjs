...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-screen text-white bg-blue-900 CustomLayout" }, _attrs))}><p>Custom it is</p>`);
...
//# sourceMappingURL=custom-VnL76hXf.mjs.map
